      ...
      <div>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 border-b border-slate-700/40 pb-2">
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: 'var(--muted-foreground)' }}>Type directly in the Courier box — it wraps exactly as the printed form ({commentsCpl} chars/line × 18 lines).</p>
          </div>
          <div className="mt-3 sm:mt-0 flex items-center gap-2">
            <span className="text-xs text-slate-400 font-semibold uppercase">Printing Pitch:</span>
            <div className="flex rounded-lg border p-0.5" style={{ borderColor: 'var(--border)', background: 'var(--form-input-bg)' }}>
