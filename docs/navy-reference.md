...
| **Comment-block geometry (line count / 90 CPL / 84 CPL)** | Appears **nowhere** in the 173-page EVALMAN — six targeted greps ("18 lines", "characters per line", "90 charac", "84 charac", "monospace", "courier") returned zero hits. Empirically derived from the form's printable area or from NAVFIT98A. **Label it as such.** It is now measured directly off the blanks in `public/` — 600 dpi raster, real ink extents, both embeddable Couriers — and is **per form**: 1616/26 Block 43 = 14/17 lines, 1616/27 Block 40 = 6/8, 1610/2 Block 41 = 16/19 (10-pitch / 12-pitch). Note **10 pitch is 12 point and 12 pitch is 10 point** — inverse, because pitch is characters per inch. The CPL figures are 75 at 10-pitch and 90 at 12-pitch, derived from the 547.200 pt clear interior all three blocks share. The single "18 lines" this row used to describe was the EVAL's figure applied to all three forms, and it was wrong on all three |
