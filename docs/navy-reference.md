...
| **Comment-block geometry (line count / 90 CPL / 84 CPL)** | Appears **nowhere** in the 173-page EVALMAN — six targeted greps ("18 lines", "characters per line", "90 charac", "84 charac", "monospace", "courier") returned zero hits. Empirically derived from the form's printable area or from NAVFIT98A. **Label it as such.** Since 2026-07-30 it is measured directly off the blanks in `public/` and is **per form**: 1616/26 Block 43 = 16/15 lines, 1616/27 Block 40 = 8/7, 1610/2 Block 41 = 19/18 (10-pitch / 12-pitch). The single "18 lines" this row used to describe was the EVAL's figure applied to all three forms, and it was wrong on all three |
