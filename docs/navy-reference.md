...
| **Block 43 geometry (18 lines / 90 CPL / 84 CPL)** | Appears **nowhere** in the 173-page EVALMAN — six targeted greps ("18 lines", "characters per line", "90 charac", "84 charac", "monospace", "courier") returned zero hits. Empirically derived from the form's printable area or from NAVFIT98A. **Label it as such** |
