...
const STRESS_COMMANDS = [
  { uic: '12345', command_name: 'USS NEVERSAIL', command_type: 'SHIP', region: 'ATLANTIC', active: true },
  { uic: '54321', command_name: 'USS ENTERPRISE', command_type: 'SHIP', region: 'PACIFIC', active: true },
  { uic: '67890', command_name: 'NAVAL HOSPITAL ROTOTA', command_type: 'SHORE', region: 'EUROPE', active: true },
]

const STRESS_USERS = [
  // 1. IT1 Group (USS ENTERPRISE - uic: 54321)
  { email: 'it1.sailor@franklyn.dev', role: 'Sailor', firstName: 'JOHN', lastName: 'REYNOLDS', mi: 'D', dodId: '1000000001', rank: 'IT1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'it1.alpha@franklyn.dev', role: 'Sailor', firstName: 'ALEXANDER', lastName: 'VANCE', mi: 'A', dodId: '1000000011', rank: 'IT1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'it1.bravo@franklyn.dev', role: 'Sailor', firstName: 'BENJAMIN', lastName: 'CROSS', mi: 'B', dodId: '1000000012', rank: 'IT1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'it1.charlie@franklyn.dev', role: 'Sailor', firstName: 'CHLOE', lastName: 'BENNETT', mi: 'C', dodId: '1000000013', rank: 'IT1', uic: '54321', cmd: 'USS ENTERPRISE' },

  // 2. ET2 Group (USS NEVERSAIL - uic: 12345)
  { email: 'et2.sailor@franklyn.dev', role: 'Sailor', firstName: 'MICHAEL', lastName: 'CHANG', mi: 'T', dodId: '1000000002', rank: 'ET2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'et2.alpha@franklyn.dev', role: 'Sailor', firstName: 'ANNA', lastName: 'SOKOLOV', mi: 'A', dodId: '1000000014', rank: 'ET2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'et2.bravo@franklyn.dev', role: 'Sailor', firstName: 'BRANDON', lastName: 'STARK', mi: 'B', dodId: '1000000015', rank: 'ET2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'et2.charlie@franklyn.dev', role: 'Sailor', firstName: 'CARMEN', lastName: 'SANTIAGO', mi: 'C', dodId: '1000000016', rank: 'ET2', uic: '12345', cmd: 'USS NEVERSAIL' },

  // 3. CTR1 Group (USS ENTERPRISE - uic: 54321)
  { email: 'ctr1.sailor@franklyn.dev', role: 'Sailor', firstName: 'SARAH', lastName: 'CONNOR', mi: 'A', dodId: '1000000003', rank: 'CTR1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'ctr1.alpha@franklyn.dev', role: 'Sailor', firstName: 'AARON', lastName: 'HOTCHNER', mi: 'A', dodId: '1000000017', rank: 'CTR1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'ctr1.bravo@franklyn.dev', role: 'Sailor', firstName: 'BLAKE', lastName: 'LIVELY', mi: 'B', dodId: '1000000018', rank: 'CTR1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'ctr1.charlie@franklyn.dev', role: 'Sailor', firstName: 'CLARK', lastName: 'KENT', mi: 'C', dodId: '1000000019', rank: 'CTR1', uic: '54321', cmd: 'USS ENTERPRISE' },

  // 4. FC2 Group (USS NEVERSAIL - uic: 12345)
  { email: 'fc2.sailor@franklyn.dev', role: 'Sailor', firstName: 'DAVID', lastName: 'MILLER', mi: 'R', dodId: '1000000004', rank: 'FC2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'fc2.alpha@franklyn.dev', role: 'Sailor', firstName: 'ALICE', lastName: 'HYDE', mi: 'A', dodId: '1000000020', rank: 'FC2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'fc2.bravo@franklyn.dev', role: 'Sailor', firstName: 'BRUCE', lastName: 'WAYNE', mi: 'B', dodId: '1000000021', rank: 'FC2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'fc2.charlie@franklyn.dev', role: 'Sailor', firstName: 'CARA', lastName: 'DUNE', mi: 'C', dodId: '1000000022', rank: 'FC2', uic: '12345', cmd: 'USS NEVERSAIL' },

  // 5. HM1 Group (NAVAL HOSPITAL ROTOTA - uic: 67890)
  { email: 'hm1.sailor@franklyn.dev', role: 'Sailor', firstName: 'EMILY', lastName: 'DAVIS', mi: 'L', dodId: '1000000005', rank: 'HM1', uic: '67890', cmd: 'NAVAL HOSPITAL ROTOTA' },
  { email: 'hm1.alpha@franklyn.dev', role: 'Sailor', firstName: 'ADAM', lastName: 'TRUITT', mi: 'A', dodId: '1000000023', rank: 'HM1', uic: '67890', cmd: 'NAVAL HOSPITAL ROTOTA' },
  { email: 'hm1.bravo@franklyn.dev', role: 'Sailor', firstName: 'BEATRICE', lastName: 'PRIOR', mi: 'B', dodId: '1000000024', rank: 'HM1', uic: '67890', cmd: 'NAVAL HOSPITAL ROTOTA' },
  { email: 'hm1.charlie@franklyn.dev', role: 'Sailor', firstName: 'CALEB', lastName: 'RIVERS', mi: 'C', dodId: '1000000025', rank: 'HM1', uic: '67890', cmd: 'NAVAL HOSPITAL ROTOTA' },

  // 6. BM3 Group (USS ENTERPRISE - uic: 54321)
  { email: 'bm3.sailor@franklyn.dev', role: 'Sailor', firstName: 'ROBERT', lastName: 'WILSON', mi: 'J', dodId: '1000000006', rank: 'BM3', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'bm3.alpha@franklyn.dev', role: 'Sailor', firstName: 'DANIEL', lastName: 'BOONE', mi: 'A', dodId: '1000000026', rank: 'BM3', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'bm3.bravo@franklyn.dev', role: 'Sailor', firstName: 'ELENA', lastName: 'ROSTOVA', mi: 'B', dodId: '1000000027', rank: 'BM3', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'bm3.charlie@franklyn.dev', role: 'Sailor', firstName: 'FINN', lastName: 'COLLINS', mi: 'C', dodId: '1000000028', rank: 'BM3', uic: '54321', cmd: 'USS ENTERPRISE' },

  // 7. MM2 Group (USS NEVERSAIL - uic: 12345)
  { email: 'mm2.sailor@franklyn.dev', role: 'Sailor', firstName: 'JAMES', lastName: 'TAYLOR', mi: 'P', dodId: '1000000007', rank: 'MM2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'mm2.alpha@franklyn.dev', role: 'Sailor', firstName: 'GREGORY', lastName: 'HOUSE', mi: 'A', dodId: '1000000029', rank: 'MM2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'mm2.bravo@franklyn.dev', role: 'Sailor', firstName: 'HANNAH', lastName: 'MARIN', mi: 'B', dodId: '1000000030', rank: 'MM2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'mm2.charlie@franklyn.dev', role: 'Sailor', firstName: 'IAN', lastName: 'MALCOLM', mi: 'C', dodId: '1000000031', rank: 'MM2', uic: '12345', cmd: 'USS NEVERSAIL' },

  // 8. OS1 Group (USS ENTERPRISE - uic: 54321)
  { email: 'os1.sailor@franklyn.dev', role: 'Sailor', firstName: 'JESSICA', lastName: 'MARTINEZ', mi: 'M', dodId: '1000000008', rank: 'OS1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'os1.alpha@franklyn.dev', role: 'Sailor', firstName: 'JACK', lastName: 'BAUER', mi: 'A', dodId: '1000000032', rank: 'OS1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'os1.bravo@franklyn.dev', role: 'Sailor', firstName: 'KATHERINE', lastName: 'PIERCE', mi: 'B', dodId: '1000000033', rank: 'OS1', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'os1.charlie@franklyn.dev', role: 'Sailor', firstName: 'LUCAS', lastName: 'SCOTT', mi: 'C', dodId: '1000000034', rank: 'OS1', uic: '54321', cmd: 'USS ENTERPRISE' },

  // 9. GM2 Group (USS NEVERSAIL - uic: 12345)
  { email: 'gm2.sailor@franklyn.dev', role: 'Sailor', firstName: 'WILLIAM', lastName: 'ANDERSON', mi: 'K', dodId: '1000000009', rank: 'GM2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'gm2.alpha@franklyn.dev', role: 'Sailor', firstName: 'MARCUS', lastName: 'BRODY', mi: 'A', dodId: '1000000035', rank: 'GM2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'gm2.bravo@franklyn.dev', role: 'Sailor', firstName: 'NANCY', lastName: 'WHEELER', mi: 'B', dodId: '1000000036', rank: 'GM2', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'gm2.charlie@franklyn.dev', role: 'Sailor', firstName: 'OLIVER', lastName: 'QUEEN', mi: 'C', dodId: '1000000037', rank: 'GM2', uic: '12345', cmd: 'USS NEVERSAIL' },

  // 10. CS3 Group (USS ENTERPRISE - uic: 54321)
  { email: 'cs3.sailor@franklyn.dev', role: 'Sailor', firstName: 'DANIEL', lastName: 'THOMAS', mi: 'S', dodId: '1000000010', rank: 'CS3', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'cs3.alpha@franklyn.dev', role: 'Sailor', firstName: 'PETER', lastName: 'PARKER', mi: 'A', dodId: '1000000038', rank: 'CS3', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'cs3.bravo@franklyn.dev', role: 'Sailor', firstName: 'QUINN', lastName: 'FABRAY', mi: 'B', dodId: '1000000039', rank: 'CS3', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'cs3.charlie@franklyn.dev', role: 'Sailor', firstName: 'RACHEL', lastName: 'GREEN', mi: 'C', dodId: '1000000040', rank: 'CS3', uic: '54321', cmd: 'USS ENTERPRISE' },

  // Raters (E-7 / CPO)
  { email: 'rater.it@franklyn.dev', role: 'Rater', firstName: 'ALAN', lastName: 'RAY', mi: 'M', dodId: '2000000001', rank: 'ITC', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'rater.et@franklyn.dev', role: 'Rater', firstName: 'BRIAN', lastName: 'KING', mi: 'W', dodId: '2000000002', rank: 'ETC', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'rater.hm@franklyn.dev', role: 'Rater', firstName: 'CAROL', lastName: 'WRIGHT', mi: 'E', dodId: '2000000003', rank: 'HMC', uic: '67890', cmd: 'NAVAL HOSPITAL ROTOTA' },

  // Senior Raters (E-8 / JO)
  { email: 'senior.rater1@franklyn.dev', role: 'Senior Rater', firstName: 'BETTY', lastName: 'SMITH', mi: 'L', dodId: '3000000001', rank: 'ITCS', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'senior.rater2@franklyn.dev', role: 'Senior Rater', firstName: 'RICHARD', lastName: 'SCOTT', mi: 'H', dodId: '3000000002', rank: 'ETCS', uic: '12345', cmd: 'USS NEVERSAIL' },

  // Reporting Seniors (CO / XO / CDR / CAPT)
  { email: 'co.enterprise@franklyn.dev', role: 'Reporting Senior', firstName: 'CARL', lastName: 'JONES', mi: 'R', dodId: '4000000001', rank: 'CDR', uic: '54321', cmd: 'USS ENTERPRISE' },
  { email: 'co.neversail@franklyn.dev', role: 'Reporting Senior', firstName: 'EDWARD', lastName: 'NIMITZ', mi: 'C', dodId: '4000000002', rank: 'CAPT', uic: '12345', cmd: 'USS NEVERSAIL' },
  { email: 'co.hospital@franklyn.dev', role: 'Reporting Senior', firstName: 'FLORENCE', lastName: 'NIGHTINGALE', mi: 'N', dodId: '4000000003', rank: 'CAPT', uic: '67890', cmd: 'NAVAL HOSPITAL ROTOTA' },

  // Admin
  { email: 'admin.stress@franklyn.dev', role: 'Admin', firstName: 'APEX', lastName: 'ADMIN', mi: 'X', dodId: '5000000001', rank: 'CAPT', uic: '00000', cmd: 'NAVY PERSONNEL COMMAND' },
] as const
...
async function seedCommands() {
  for (const cmd of STRESS_COMMANDS) {
    ...
    if (error) throw new Error(`commands upsert (${cmd.uic}): ${error.message}`)
...
async function deleteStressEvals() {
  ...
  const { data } = await admin.from('evaluations').select('id').like('dod_id', '10000000%')
  if (data?.length) {
  ...
  const { data: grps } = await admin.from('summary_groups').select('id').like('name', '%Summary Group%')
  if (grps?.length) {
    const gIds = grps.map((g) => g.id)
    await admin.from('summary_groups').delete().in('id', gIds)
    console.log(`  removed ${gIds.length} existing stress test summary group(s)`)
  }
}
...
async function seedStressEvals(users: Record<string, string>) {
  ...
  const summaryGroupDefs = [
    { rate: 'IT1', rsEmail: 'co.enterprise@franklyn.dev', cmd: 'USS ENTERPRISE' },
    { rate: 'ET2', rsEmail: 'co.neversail@franklyn.dev', cmd: 'USS NEVERSAIL' },
    { rate: 'CTR1', rsEmail: 'co.enterprise@franklyn.dev', cmd: 'USS ENTERPRISE' },
    { rate: 'FC2', rsEmail: 'co.neversail@franklyn.dev', cmd: 'USS NEVERSAIL' },
    { rate: 'HM1', rsEmail: 'co.hospital@franklyn.dev', cmd: 'NAVAL HOSPITAL ROTOTA' },
    { rate: 'BM3', rsEmail: 'co.enterprise@franklyn.dev', cmd: 'USS ENTERPRISE' },
    { rate: 'MM2', rsEmail: 'co.neversail@franklyn.dev', cmd: 'USS NEVERSAIL' },
    { rate: 'OS1', rsEmail: 'co.enterprise@franklyn.dev', cmd: 'USS ENTERPRISE' },
    { rate: 'GM2', rsEmail: 'co.neversail@franklyn.dev', cmd: 'USS NEVERSAIL' },
    { rate: 'CS3', rsEmail: 'co.enterprise@franklyn.dev', cmd: 'USS ENTERPRISE' },
  ]
  ...
  for (const def of summaryGroupDefs) {
    ...
    const { data: gData, error: gErr } = await admin
      .from('summary_groups')
      .upsert(groupPayload, { onConflict: 'reporting_senior_id,period_to,grade_rate,promotion_status,report_type' })
      .select('id')
      .single()
    if (gErr) throw new Error(`summary_groups upsert (${def.rate}): ${gErr.message}`)
  ...
  const stages: Array<{ stage: Evaluation['routing_stage']; status: Evaluation['status']; holderRole: string }> = [
    { stage: 'reporting_senior', status: 'ready_for_review', holderRole: 'reportingSenior' },
    { stage: 'senior_rater', status: 'ready_for_review', holderRole: 'seniorRater' },
  ...
  for (let i = 0; i < 40; i++) {
    ...
    const template = BLOCK_43_TEMPLATES.find((t) => t.rate === def.rate) || BLOCK_43_TEMPLATES[0]
    ...
    const cmdInfo = STRESS_COMMANDS.find((c) => c.command_name === def.cmd) || STRESS_COMMANDS[0]
    ...
    if (stageInfo.holderRole === 'rater') holderId = users['rater.it@franklyn.dev']
    else if (stageInfo.holderRole === 'seniorRater') holderId = users['senior.rater1@franklyn.dev']
    else if (stageInfo.holderRole === 'reportingSenior') holderId = users[def.rsEmail]

    let gradeVal = '4.0'
    let avg = 4.0
    if (promRec === 'Early Promote') { gradeVal = '5.0'; avg = 5.0 }
    else if (promRec === 'Must Promote') { gradeVal = '4.0'; avg = 4.0 }
    else if (promRec === 'Promotable') { gradeVal = '3.0'; avg = 3.0 }
    else if (promRec === 'Progressing') { gradeVal = '2.0'; avg = 2.0 }
    else if (promRec === 'Significant Problems') { gradeVal = '1.0'; avg = 1.0 }
    ...
    const evalPayload = buildValidEval({
      ...
      participants: stageInfo.stage === 'sailor' ? [creatorId] : [creatorId, holderId],
      ...
      retention: promRec === 'Significant Problems' ? 'Not Recommended' : 'Recommended',
      ...
      block_values: {
        ...
        periodic: true,
        regular_report: true,
        reporting_senior_name: def.rate === 'HM1' ? 'NIGHTINGALE, F N' : (def.cmd === 'USS NEVERSAIL' ? 'NIMITZ, E C' : 'JONES, C R'),
        ...
        reporting_senior_dod_id: def.rate === 'HM1' ? '4000000003' : (def.cmd === 'USS NEVERSAIL' ? '4000000002' : '4000000001'),
        ...
        substantiation_comments: promRec === 'Significant Problems' || promRec === 'Progressing' ? 'MEMBER EXPERIENCED SIGNIFICANT PERFORMANCE CHALLENGES REQUIRED MANDATORY COUNSELING.' : undefined,
      },
    })
  ...
  const { data: inserted, error } = await admin.from('evaluations').insert(evalsToInsert).select('id, member_name, grade_rate, routing_stage, promotion_recommendation, summary_group_id')
  if (error) throw new Error(`evaluations insert: ${error.message}`)

  console.log(`  successfully seeded ${inserted!.length} detailed stress test evaluations across 10 summary groups!`)
