...
export const TRAIT_STANDARDS: Record<TraitKey, TraitStandard> = {
  ...
  eo: {
    ...
    definition: 'Contributions to growth and development, human worth, community',
    anchors: {
      '1.0': [
  ...
  bearing: {
    ...
    definition: 'Appearance, conduct, physical fitness, adherence to Navy Core Values',
    anchors: {
      '1.0': [
  ...
  leadership: {
    block: 39,
    title: 'Leadership',
    definition: 'Organizing, motivating and developing others to accomplish goals',
    anchors: {
      '1.0': [
