...
describe('RoleGuard Component', () => {
  ...
  it('should render fallback when access is denied', () => {
    render(
      <RoleGuard user={sailorUser} requiredPermission="manage_users" fallback={<div>No Access</div>}>
        <div>Admin Content</div>
      </RoleGuard>
    )
    expect(screen.queryByText('Admin Content')).toBeNull()
  ...
  it('should use contextual action check with evaluation', () => {
    render(
      <RoleGuard user={sailorUser} requiredAction="edit_evaluation" evaluation={mockEval}>
        <div>Edit Form</div>
      </RoleGuard>
    )
  ...
  it('should deny contextual action when not the creator', () => {
    ...
    render(
      <RoleGuard user={otherSailor} requiredAction="edit_evaluation" evaluation={mockEval}>
        <div>Edit Form</div>
      </RoleGuard>
    )
...
describe('AccessDeniedPanel', () => {
  it('should render with default message', () => {
    ...
    expect(screen.getByText(/do not have the required permissions/i)).toBeDefined()
  })
