...
describe('NAVPERS 1616/26 trait standards', () => {
  ...
  it('matches a known verbatim anchor (Block 34, 5.0) against the form', () => {
    expect(TRAIT_STANDARDS.work.anchors['5.0']).toContain('Always produces exceptional work')
    expect(TRAIT_STANDARDS.knowledge.anchors['1.0']).toContain('Marginal knowledge of rating, specialty or job')
  })
})
