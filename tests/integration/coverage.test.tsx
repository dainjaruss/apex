...
const { mockQueryStore, MockSupabaseQuery, mockExchangeCode, mockGetUser } =
  vi.hoisted(() => {
    ...
    class MockSupabaseQuery {
      ...
      then(resolve: any) {
        ...
        return Promise.resolve({
          data: mockQueryStore.data,
          error: mockQueryStore.error,
        });
      }
    }
...
describe("APEX Comprehensive Test Coverage Suite", () => {
  ...
  it("should call auth callback route GET and handle redirect", async () => {
    const request = new Request(
      "https://apex.mil/auth/callback?code=mock-code",
    );
